...
input_dir = r'dataset/watermelon-disease/Augmented Image/Augmented_Image'
output_dir = r'dataset/watermelon-disease/Augmented Image/Augmented_Image/train_test_split'
